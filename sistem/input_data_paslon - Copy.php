...
<head>
  ...
  <title>Aplikasi E-VOTING FIP</title>
  <!-- BOOTSTRAP STYLES-->
          ...
          <div class="menu">
            <ul class="main-menu" id="main-menu">
              ...
              if($level){
                ?>
                <li>
                  <a href="input_data_paslon.php">
                  Informasi</a>
                </li>

                <li>
                   <a href="upload_dpt.php">Data Siswa</a>
                </li>

                <li>
                  <a href="input_data_paslon.php">Data Kandidat</a>
                </li>
...
<div class="footer">
  <div class="row">
    <div class="col-lg-12" >
      &copy; Copyright MPK ICB <?php echo date('Y') ?> <a href="http://binarytheme.com" style="color:#fff;" target="_blank"></a>
    </div>
  </div>
</div>
